...
> = {
  ...
  'Classical': [
    {
      ...
      category: 'Classical',
      imageUrl: '/src/distorted-reflection.png',
  ...
  'Pop': [
    ...
    },
    {
      ...
      category: 'Pop',
      imageUrl: '/src/summer-in-my-youth.png',
